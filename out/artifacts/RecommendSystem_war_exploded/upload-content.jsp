...
<div class="page-container" id="page">
    <div class="container">
        <div class="row">
            <form id="form" method="post" action="ArticleServlet">
                <div>
                    <font style="color: black;" size="5px">新闻标题&nbsp;&nbsp;&nbsp;&nbsp;</font>
                    <input type="text" style="width:440px;" id="topic" name="title">
                </div>
                <br>
                <div>
                    <font style="color: black;" size="5px">新闻类别&nbsp;&nbsp;&nbsp;&nbsp;</font>
                ...
                <br>
                <div>
                    <font style="color: black;" size="5px">新闻正文&nbsp;&nbsp;&nbsp;&nbsp;</font>
                    <textarea style="width: 660px; height: 440px;" id="text" name="content"></textarea>
                </div>
                <br>
                <div>
                    <font style="color: white;" size="0.01px">凑字数的凑字数的&nbsp;&nbsp;&nbsp;&nbsp;</font>
                    <input type="checkbox" name="promise" value="yes" id="promise" checked="checked"/>本人承诺，上传资讯属实。若存在任何不实信息，由本人承担法律责任，与23News平台无关。
                </div>
                <br>
                <div style="align-content: center">
                    <font style="color: white;" size="0.01px">凑字数的凑字数的&nbsp;&nbsp;&nbsp;&nbsp;</font>
                    <a  class="btn btn-default" onclick="return up()">确认上传</a>
                </div>
            </form>
        </div>
    </div>
...
<script>
    ...
    function up(){
        ...
        $.ajax({
            type:"POST",
            url:"FilterServlet",
            data:{username:'<%=username%>',content:text.value},
            success:function(data,textStatus){
                result = data.split(':');
