            ...
            <nav class="main-nav">
                <div class="menu-top-menu-container">
                    <ul id="menu-top-menu" class="clearfix">
                        ...
                        <li class="current-menu-item"><a href="articles_type_films.jsp">影视</a></li>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="span8 main-listing">
                ...
                <%
                    List<ClassifyArticle> as = GetArticleByType.getArticlesByType("film");
                    System.out.println("film : "+as.size());
                    int index = 0;
                    String url = "";
               ...
               <%
                   ...
                   index = DAO.ChangePageFilmsServlet.getPage();
                   ...
                   List<UpLoadArticle> upLoadls = GetArticleByType.getUploadArticleByType("films");
                   if(upLoadls.size()>0){
                   ...
                   //数据库获取
                    ...
                    for(int i=index;i<16+index&&i<as.size();i++)
                    {
                      ...
                      <header class="clearfix">
                        ...
                        <div class="post-meta clearfix">
                            <span class="date"><%="2018-"+(random.nextInt(3)+1)+"-"+(random.nextInt(30)+1)%></span>
               ...
               %>
                ...
                <div id="pagination">
                    <a href="articles_type_films.jsp" class="btn" onclick="onLast()">上一页 »</a>
                    <a href="articles_type_films.jsp" class="btn" onclick="onNext()">下一页 »</a>
                </div>
