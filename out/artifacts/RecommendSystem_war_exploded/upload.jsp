...
--%>
<%@ page contentType="text/html;charset=UTF-8" language="java" import="entity.UpLoadArticle" %>
            ...
            <nav class="main-nav">
                <div class="menu-top-menu-container">
                    <ul id="menu-top-menu" class="clearfix">
                        ...
                        <li class="current-menu-item"><a href="" id="upload">上传</a></li>
...
<div class="page-container" id="page">
    <div class="container">
        <div class="row">
            <a href="upload-content.jsp"><h3 style="margin-left: 380px;"><u>点击上传原创新闻</u></h3></a>
            ...
            <div class="span8 main-listing">
                ...
                <%
                    ...
                    List<UpLoadArticle> as = tool.GetUpLoadArticle.getUpLoadArticle();
                    int index = 0;
                    String url = "";
                %>
                ...
                <%
                    ...
                    index = DAO.DeleteUploadServlet.getPage();
                    ...
                    if(as.size()>0){
                        ...
                        for(int i=index;i<as.size();i++)
                        {
                            if(!as.get(i).getAuthor().equals(username)){
                                continue;
                            }
                            url = "articlebyuser-display.jsp?item_id="+as.get(i).getId()+"&user_name="+username;
                ...
                <article class="format-standard type-post hentry clearfix" id="<%="article_"+i%>">
                    ...
                    <header class="clearfix">
                        ...
                        <div class="post-meta clearfix">
                            <span class="date"><%=as.get(i).getTime()%></span>
                            <span  id="<%="likeitem_"+as.get(i).getId()%>" style="float:right" onclick="Unlike(this)">
                                <img id="<%="like_"+as.get(i).getId()%>" src="images/cha.jpg">
                            </span>
...
<script>
    ...
    function up(){
        ...
        if($("#promise").attr("checked")!="checked"){
            alert("请勾选承诺保证");
            return false;
        }
        alert("上传成功")
