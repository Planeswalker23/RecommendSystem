            ...
            <nav class="main-nav">
                <div class="menu-top-menu-container">
                    <ul id="menu-top-menu" class="clearfix">
                        ...
                        <li class="current-menu-item"><a href="articles_type_game.jsp">游戏</a></li>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="span8 main-listing">
                ...
                <%
                    List<ClassifyArticle> as = GetArticleByType.getArticlesByType("game");
                    System.out.println("game : "+as.size());
                    int index = 0;
                    String url = "";
               ...
               <%
                   ...
                   index = DAO.ChangePageGameServlet.getPage();
                   ...
                   List<UpLoadArticle> upLoadls = GetArticleByType.getUploadArticleByType("game");
                   if(upLoadls.size()>0){
               ...
               %>
                ...
                <div id="pagination">
                    <a href="articles_type_game.jsp" class="btn" onclick="onLast()">上一页 »</a>
                    <a href="articles_type_game.jsp" class="btn" onclick="onNext()">下一页 »</a>
                </div>
