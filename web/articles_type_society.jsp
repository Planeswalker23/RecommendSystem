            ...
            <nav class="main-nav">
                <div class="menu-top-menu-container">
                    <ul id="menu-top-menu" class="clearfix">
                        ...
                        <li class="current-menu-item"><a href="articles_type_society.jsp">社会</a></li>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="span8 main-listing">
                ...
                <%
                    List<ClassifyArticle> as = GetArticleByType.getArticlesByType("society");
                    System.out.println("society : "+as.size());
                    int index = 0;
                    String url = "";
               ...
               <%
                   ...
                   index = DAO.ChangePageSocietyServlet.getPage();
                   ...
                   List<UpLoadArticle> upLoadls = GetArticleByType.getUploadArticleByType("society");
                   if(upLoadls.size()>0){
               ...
               %>
                ...
                <div id="pagination">
                    <a href="articles_type_society.jsp" class="btn" onclick="onLast()">上一页 »</a>
                    <a href="articles_type_society.jsp" class="btn" onclick="onNext()">下一页 »</a>
                </div>
