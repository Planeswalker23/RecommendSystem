            ...
            <nav class="main-nav">
                <div class="menu-top-menu-container">
                    <ul id="menu-top-menu" class="clearfix">
                        ...
                        <li class="current-menu-item"><a href="articles_type_physical.jsp">体育</a></li>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="span8 main-listing">
                ...
                <%
                    List<ClassifyArticle> as = GetArticleByType.getArticlesByType("sports");
                    System.out.println("sports : "+as.size());
                    int index = 0;
                    String url = "";
               ...
               <%
                   ...
                   index = DAO.ChangePagePhysicalServlet.getPage();
                   ...
                   List<UpLoadArticle> upLoadls = GetArticleByType.getUploadArticleByType("physical");
                   if(upLoadls.size()>0){
               ...
               %>
                ...
                <div id="pagination">
                    <a href="articles_type_physical.jsp" class="btn" onclick="onLast()">上一页 »</a>
                    <a href="articles_type_physical.jsp" class="btn" onclick="onNext()">下一页 »</a>
                </div>
