            ...
            <nav class="main-nav">
                <div class="menu-top-menu-container">
                    <ul id="menu-top-menu" class="clearfix">
                        ...
                        <li class="current-menu-item"><a href="articles_type_cultural.jsp">人文</a></li>
        ...
        <div class="row">
            ...
            <div class="span8 main-listing">
               ...
               <%
                   ...
                   index = DAO.ChangePageCulturalServlet.getPage();
               ...
               %>
                ...
                <div id="pagination">
                    <a href="articles_type_cultural.jsp" class="btn" onclick="onLast()">上一页 »</a>
                    <a href="articles_type_cultural.jsp" class="btn" onclick="onNext()">下一页 »</a>
                </div>
