        ...
        <div class="row">
            ...
            <div class="span8 main-listing">
               ...
               <%
                   ...
                   index = DAO.ChangePageEducationServlet.getPage();
               ...
               %>
                ...
                <div id="pagination">
                    <a href="articles_type_education.jsp" class="btn" onclick="onLast()">上一页 »</a>
                    <a href="articles_type_education.jsp" class="btn" onclick="onNext()">下一页 »</a>
                </div>
...
<script>
    function onNext(){
        $.ajax({
            type:"POST",
            url:"ChangePageEducationServlet",
            data:{name:"next"},
